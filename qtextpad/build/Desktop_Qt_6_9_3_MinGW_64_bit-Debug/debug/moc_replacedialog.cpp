...
void ReplaceDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->findNextRequested(); break;
        case 1: _t->replaceOneRequested(); break;
        case 2: _t->replaceAllRequested(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ReplaceDialog::*)()>(_a, &ReplaceDialog::findNextRequested, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ReplaceDialog::*)()>(_a, &ReplaceDialog::replaceOneRequested, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (ReplaceDialog::*)()>(_a, &ReplaceDialog::replaceAllRequested, 2))
            return;
    }
}
...
// SIGNAL 0
void ReplaceDialog::findNextRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void ReplaceDialog::replaceOneRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void ReplaceDialog::replaceAllRequested()
{
